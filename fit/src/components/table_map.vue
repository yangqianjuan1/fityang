<template>
  <div class="pages">
    ...
    >
      ...
      <div
        v-if="tabPosition == 'table'"
        v-show="tabPosition =='table'"
        class="table_wrap"
      >
        <el-table
          :data="tableData"
    ...
    addPoint(data, type) {
      ...
      if (positionArray.length > 0) {
        for (let i = 0; i < positionArray.length; i++) {
          // 一个坐标对应一个mark的生成
          let point = new BMap.Point(positionArray[i][0], positionArray[i][1]);
          let myIcon = new BMap.Icon(vm.pointImg, new BMap.Size(24, 24));
      ...
      if (vm.showType == "zy") {
        ...
        if (vm.mapUrl === "energy_station_map") {
          ...
          data.voltageWarnCount != ""
            ? (str +=
                "<p>蓄电池电压告警数量：" + data.voltageWarnCount + "个</p>")
            : (str += "<p>蓄电池电压告警数量：0</p>");
          data.tempWarnCount != ""
            ? (str += "<p>蓄电池温度告警数量：" + data.tempWarnCount + "个</p>")
            : (str += "<p>蓄电池温度告警数量：0</p>");
        } else {
          data.topDisChargeCount != ""
            ? (str +=
        ...
        energyStation.capacity != ""
          ? (str +=
              "<p>储能电池容量总计：" + energyStation.capacity + "KWH</p>")
          : (str += "<p>储能电池容量总计：0</p>");
        energyStation.fdl != ""
          ? (str += "<p>削峰填谷能力：" + energyStation.fdl + "KWH</p>")
          : (str += "<p>削峰填谷能力：0</p>");
        energyStation.ljjfje != ""
          ? (str += "<p>累计节费金额：" + energyStation.ljjfje + "元</p>")
          : (str += "<p>累计节费金额：0</p>");
        energyStation.dzrjfdsc != ""
          ? (str += "<p>单站日均放电时长：" + energyStation.dzrjfdsc + "H</p>")
          : (str += "<p>单站日均放电时长：0</p>");
        prolongStation.t0pjyjsc != ""
          ? (str += "<p>T0平均应急时长：" + prolongStation.t0pjyjsc + "H</p>")
          : (str += "<p>T0平均应急时长：0</p>");
        prolongStation.t1pjyjsc != ""
          ? (str += "<p>T1平均应急时长：" + prolongStation.t1pjyjsc + "H</p>")
          : (str += "<p>T1平均应急时长：0</p>");
        prolongStation.t1pjyjsc != ""
          ? (str += "<p>延寿管理提升：" + prolongStation.t1pjyjsc + "%</p>")
          : (str += "<p>延寿管理提升：0</p>");
        prolongStation.t1pjyjsc != ""
          ? (str += "<p>应急次数：" + prolongStation.t1pjyjsc + "次</p>")
          : (str += "<p>应急次数：0</p>");
