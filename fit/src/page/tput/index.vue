                ...
                <div class="wrap">
                    <div class="topology">
                        ...
                        <div class="cdz1 red">
                            <el-tooltip placement="top">
                                <div slot="content">
                                    <label v-if="chargeHubInfo == ''" style="top: 197px; left: 501px;">暂无数据</label>
...
export default {
    ...
    methods: {
        ...
        dianchi(id) {
            window.open(
                `http://www.baoxingtech.com:2137/construction/sync/siteDetail.html?functionId=0&panelId=${id}`
            );
        },
        gotharf(item) {
            window.open(
                `http://www.baoxingtech.com:2137/construction/sync/siteDetail.html?functionId=0&panelId=${
                    item.id
